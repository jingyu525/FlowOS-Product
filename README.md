...
*   **v1.3 自动化、集成与 AI 代理支持 (Automation, Integration & AI Agents)**
    *   引入自动化脚本与第三方工具集成，大幅提升工作流效率。详细指南请参考：[自动化与集成指南](./99-手册/04-系统维护/07-自动化与集成指南.md)。
    *   提供前沿的 AI 代理接入能力，助力个人知识库智能化管理。详细指南请参考：[AI代理接入指南](./99-手册/04-系统维护/08-AI代理接入指南.md)。
